...
public class EventosController {
	...
	public String salvarConvidado(@PathVariable @Valid Long idEvento, @Valid Convidado convidado, BindingResult result, RedirectAttributes attributes) {

		if (result.hasErrors()) {
			return form(convidado);
		}
